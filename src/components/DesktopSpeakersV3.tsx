...
export const DesktopSpeakersV3 = () => {
  return (
    <div className="w-full border-y border-black/5 bg-[#f8f8f8] px-6 py-20 font-sans flex justify-center">
      <div className="w-full max-w-[1180px] flex flex-col">
        ...
        <div className="grid grid-cols-1 gap-x-5 gap-y-10 md:grid-cols-2 xl:grid-cols-4">
          {RESEARCH_SPEAKERS.map((member) => (
            <article key={member.name} className="group flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-3">
                <div>
                  <h3 className="mb-1 text-[15px] font-bold uppercase tracking-tight leading-tight text-black/92">
                    {member.name}
                  </h3>
                ...
                <p className="border-t border-black/8 pt-3 text-[12px] leading-[1.58] text-black/68">
                  {member.description}
                </p>
              </div>
            </article>
